...
import 'package:signify_app/ui/saved_quotes/widgets/delete_quotes_button.dart';
import 'package:signify_app/ui/saved_quotes/widgets/saved_quotes_list.dart';
...
class SavedQuotesScreen extends StatefulWidget {
  ...
  @override
  SavedQuotesScreenState createState() => SavedQuotesScreenState();
}

class SavedQuotesScreenState extends State<SavedQuotesScreen> {
  @override
  void initState() {
    super.initState();
